...
センサを用いないで反力を推定する研究には，内視鏡画像から反力を推定する研究と，駆動用モータやワイヤから反力を推定する研究がある.
まず，画像ベースの研究に関して，
...
研修医の超音波ガイド下での処置の練習対象として，鶏むね肉や，豆腐，ゼラチンを用いられ，縫合の練習対象としてバナナ,豆腐，ゼラチンを用いる場合があることから\cite{exp_ref1}\cite{exp_ref2}\cite{exp_ref3}，
